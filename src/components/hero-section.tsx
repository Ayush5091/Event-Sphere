    ...
    return (
        <main className="overflow-x-hidden">
            <section className='lg:h-screen relative overflow-hidden'>
                <ParticleBackground />
                <div
                    className="relative z-10 pb-8 pt-12 md:pb-16 lg:pb-24 lg:pt-44 lg:grid lg:grid-cols-2 lg:grid-rows-1 grid-cols-1 grid-rows-2">
                    <div className="relative mx-auto flex max-w-xl flex-col px-6 lg:block">
                        <div className="mx-auto max-w-2xl text-center lg:ml-0 lg:text-left">
                            <div className='mt-8 lg:mt-16'>
                                <DecryptedText
                                    text="Join the Ultimate Event Platform"
                                    animateOn="view"
                            ...
                            <TextEffect
                                ...
                                Discover, create, and manage your events seamlessly. Join our growing community of event organizers and attendees.
                            </TextEffect>
                            <AnimatedGroup
                                variants={{
                                    container: {
